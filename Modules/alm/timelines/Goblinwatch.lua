...
timeline:to(alm.Camera, {X = -18829, Y = -10431, Z = 22, Yaw = 1288, Pitch = 0, duration = 8})
timeline:to(alm.Camera, {X = -18829, Y = -10431, Z = 22, Yaw = 812, Pitch = 0, duration = 3})
timeline:to(alm.Camera, {X = -18253, Y = -4038, Z = 501, Yaw = 480, Pitch = 0, duration = 8})
timeline:to(alm.Camera, {X = -20618, Y = -1245, Z = 160, Yaw = 968, Pitch = 0, duration = 5})
